...
const CreateCustomer = ({navigation,setModal,datafetch}) => {
  ...
  const handleSubmit = async () => {
    if (validateFields()) {
      ...
      try {
        ...
        if(response.success){
          setModal(false)
          Toast.success("Sender Added Sucessfully");
  ...
  return (
    <>
      ...
      <View>
        <Text style={styles.adsender}>Add Sender</Text>
      </View>
      ...
      <View>
        ...
        <Text style={styles.label}>Select Sender Identification Type:</Text>
